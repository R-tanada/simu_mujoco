...
class RoboControl:
    ...
    def set_transform_cartesian(self, x, z, pitch, gripper):
        ...
        z = z*0.001
        pitch = pitch * np.pi / 180
        q1, q2, q3, q4 = self.inverse_kinematics_3dof(x, z, pitch)
    ...
    def set_transform_with_controller(self, button_state: dict):
        ...
        self.mujo.set_joint_transform(self.current_x, self.current_z, self.current_pitch, 255- button_state["gripper"]*255)
        self.mujo.step()
